...
const RegisterAccountFormVar1 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    "category": "register",
                    "type": "section",
                    "component": "RegisterAccountFormVar1",
                    ...raw_data,
                }
            },
                    ...
                    <div className="w-full max-w-lg">
                        ...
                        <div className="text-center mb-8">
                            ...
                            bg-${helpers.adjustColorShadeByPercent(themeSett.primary_color, -40)} rounded-lg mb-4`}>
                                <BiUserPlus className={`w-6 h-6 text-${themeSett.primary_color}`} />
                            </div>
                            <h1 className="text-3xl font-bold text-gray-900">{raw_data.header || "Create a New Account"}</h1>
                            <p className="text-gray-600 mt-2">{raw_data.sub_header || "Provide your info to register a new account."}</p>
                        </div>
...
export default RegisterAccountFormVar1