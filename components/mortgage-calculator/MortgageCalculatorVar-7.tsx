...
const MortgageCalculatorVar7 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "MortgageCalculatorVar7",
                    ...raw_data,
                }
            },
                ...
                <div className="container mx-auto max-w-[1100px]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div className="lg:col-span-7 lg:border-r lg:pr-10" style={{ borderColor: '#E5E7EB' }}>
                            <div className="text-xs uppercase tracking-widest font-semibold mb-4" style={{ color: '#111111' }}>
                                Enter Your Figures
                            </div>
                            ...
                            <div className={`mt-10 ${!show_calc ? "hidden" : ""}`}>
                                <div className="text-xs uppercase tracking-widest font-semibold mb-3" style={{ color: '#111111' }}>
                                    Footnotes &amp; Working
                                </div>
                                <ol className="list-decimal pl-4 space-y-3 text-sm font-serif" style={{ color: '#374151' }} id="further_brk_dwn"></ol>
                            </div>
                        </div>

                        {/* Pull-quote result column */}
...
export default MortgageCalculatorVar7