...
const MortgageCalculatorVar8 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "MortgageCalculatorVar8",
                    ...raw_data,
                }
            },
                    ...
                    <div className="border-4 p-6 md:p-10" style={{ borderColor: '#111111', background: '#FFFFFF', boxShadow: '10px 10px 0 #111111' }}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <FloatingInput name='downpay_dollar' label='DOWN $' placeholder='Down Payment Amount'
                                ...
                                <FloatingInput name='downpay_percent' label='DOWN %' placeholder='Down Payment Percentage'
                        ...
                        <div className="border-t-4 mt-8 pt-6" style={{ borderColor: '#111111' }}>
                            <label className="flex items-center gap-3 cursor-pointer select-none" htmlFor="show_calc">
                                <input type='checkbox' className='w-5 h-5' name='show_calc' id='show_calc' checked={show_calc} onChange={handleShowCalc} />
                                <span className="text-sm font-bold uppercase" style={{ color: '#111111' }}>
                                    Show calculations + amortization
                                </span>
                            </label>

                            <button
                                onClick={CalculateMortagage}
                                className="mt-6 px-8 py-4 border-4 font-black uppercase flex items-center gap-2 transition-transform hover:-translate-y-1 hover:-translate-x-1"
                                style={{ borderColor: '#111111', background: '#F5E000', color: '#111111', boxShadow: '6px 6px 0 #111111' }}
                            >
                                <PiMathOperations size={20} /> Calculate
                            </button>
                        </div>
                    </div>

                    <div className="mt-10 border-4 p-8 text-center" style={{ borderColor: '#111111', background: '#F5E000', boxShadow: '10px 10px 0 #111111' }}>
                        <div className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#111111' }}>Monthly Payment</div>
                        <div className="text-6xl md:text-7xl font-black" style={{ color: '#111111' }}>{monthly_payment}</div>
                    </div>

                    <div className={`mt-10 border-4 p-6 md:p-8 ${!show_calc ? "hidden" : ""}`} style={{ borderColor: '#111111', background: '#FFFFFF' }}>
                        <div className="text-sm font-black uppercase mb-4" style={{ color: '#111111' }}>The Math</div>
                        <ol className="list-decimal pl-4 space-y-3 text-sm font-semibold" style={{ color: '#111111' }} id="further_brk_dwn"></ol>
                    </div>

                    <div className={`w-full mt-8 overflow-x-auto border-4 ${!show_calc ? "hidden" : ""}`} style={{ borderColor: '#111111' }} id='monthly_breakdown'></div>
                </div>
...
export default MortgageCalculatorVar8