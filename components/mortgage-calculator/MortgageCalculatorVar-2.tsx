...
const MortgageCalculatorVar2 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
            ...
            <section className="w-full min-h-[100dvh] flex justify-center py-35 px-4 bg-gray-100">
                <div className="w-full max-w-[1240px] flex flex-col items-center justify-center">
                    ...
                    <div className="w-full max-w-[640px]">
                        ...
                        <div className="w-full bg-white rounded-2xl py-4 px-4 md:py-10 md:px-6 shadow-2xl">
                            ...
                            <div className="space-y-6">
                                ...
                                <button onClick={() => CalculateMortagage(show_calc)} className={`w-full p-3.5 rounded font-medium flex items-center 
                                justify-center gap-2 transition-all bg-${themeSett.primary_color} 
                        ...
                        <div className={`mt-10 ${!show_calc ? "hidden" : ""}`}>
                            <div className="text-lg font-serif mb-3">Calculations &amp; Amortization</div>
                            <ol className="list-decimal pl-4 space-y-3 text-sm" style={{ color: '#404040' }} id="further_brk_dwn"></ol>
                        </div>
                    </div>
...
export default MortgageCalculatorVar2