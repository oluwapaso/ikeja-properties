...
const MortgageCalculatorVar3 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "MortgageCalculatorVar1",
                    ...raw_data,
                }
            },
    ...
    if (themeSett && themeSett != null) {
        return (
            <section className="w-full min-h-[100dvh] py-35 px-4 bg-zinc-50">
                <div className="container mx-auto max-w-[1100px]">
                    ...
                    <div className="flex items-center justify-between mb-10">
                        ...
                        <div className="hidden md:block text-right">
                            <div className="font-mono text-[10px] uppercase tracking-widest text-zinc-500">STATUS</div>
                            <div className="font-mono text-sm text-emerald-600">● LIVE</div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-white rounded-2xl p-6 md:p-8 border border-zinc-200 shadow-sm">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                ...
                                <FloatingInput
                                    ...
                                    placeholder='30'
                                    handleChange={handleChange}
                                    value={calc_data.length_of_mortgage.toString()}
                                    required
                                    data-is-number
                                    handleBlur={handleInputBlur}
                                    data-max-len={2}
                                ...
                                <FloatingInput
                                    ...
                                    placeholder='10'
                                    handleChange={handleChange}
                                    value={calc_data.interest_rate.toString()}
                                    required
                                    data-is-percent
                                    handleBlur={handleInputBlur}
                                    data-max-len={3}
                        ...
                        {/* Result Card */}
                        <div className="bg-white rounded-2xl p-6 md:p-8 border border-zinc-200 shadow-sm flex flex-col justify-between">
                            ...
                            <p className="text-zinc-600 text-sm mt-8 leading-relaxed">
                ...
                {/* Editor Controls (if in theme editor) */}
                {is_theme && (
...
export default MortgageCalculatorVar3