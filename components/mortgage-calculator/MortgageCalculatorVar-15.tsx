...
import { PiMathOperations, PiSmiley } from 'react-icons/pi'
...
const MortgageCalculatorVar15 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "MortgageCalculatorVar15",
                    ...raw_data,
                }
            },
    ...
    if (themeSett && themeSett != null) {
        return (
            <section className="w-full min-h-[100dvh] py-35 px-4 relative" style={{ background: '#FFF1F6' }}>
                <div className="container mx-auto max-w-[700px]">

                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-4" style={{ background: '#FFD9E8' }}>
                        <PiSmiley size={16} color="#DB2777" />
                        <span className="text-xs font-bold" style={{ color: '#DB2777' }}>Let's find your number!</span>
                    </div>
                    <h1 className="text-4xl font-extrabold mb-10" style={{ color: '#1F2937' }}>Mortgage Calculator 🏡</h1>

                    <div className="bg-white rounded-[28px] p-7 md:p-9" style={{ boxShadow: '0 16px 40px rgba(219,39,119,0.12)' }}>

                        <div className="space-y-5">
                            <div>
                                <div className="text-sm font-bold mb-1.5" style={{ color: '#1F2937' }}>How much is the home? 💰</div>
                            ...
                            <div>
                                <div className="text-sm font-bold mb-1.5" style={{ color: '#1F2937' }}>Down payment 🪙</div>
                            ...
                            <div>
                                <div className="text-sm font-bold mb-1.5" style={{ color: '#1F2937' }}>Loan details 📋</div>
                                <div className="grid grid-cols-2 gap-3">
                            ...
                            <button
                                ...
                                className={`w-full py-4 rounded-full font-extrabold flex items-center justify-center gap-2 
                                 transition-transform hover:scale-[1.02] active:scale-[0.98] hover:shadow-2xl cursor-pointer
                    ...
                    {/* result sticker */}
                    <div className="mt-8 rounded-[28px] p-8 text-center" style={{ background: '#1F2937' }}>
                        <div className="text-xs font-bold uppercase tracking-widest" style={{ color: '#F9A8D4' }}>Your monthly payment</div>
                        <div className="text-5xl font-extrabold mt-2 text-white">{monthly_payment}</div>
                        <div className="text-2xl mt-1">🎉</div>
                    </div>

                    <div className={`mt-8 bg-white rounded-[28px] p-6 md:p-8 ${!show_calc ? "hidden" : ""}`} style={{ boxShadow: '0 16px 40px rgba(219,39,119,0.08)' }}>
                        <div className="text-sm font-bold mb-4" style={{ color: '#1F2937' }}>Here's the math 🧮</div>
                        <ol className="list-decimal pl-4 space-y-3 text-sm" style={{ color: '#4B5563' }} id="further_brk_dwn"></ol>
                    </div>

                    <div className={`w-full mt-6 overflow-x-auto rounded-[24px] ${!show_calc ? "hidden" : ""}`} id='monthly_breakdown'></div>
                </div>
...
export default MortgageCalculatorVar15