                    ...
                    <div className="w-full max-w-md relative z-10">
                        ...
                        <div className="bg-gradient-to-br from-gray-900 via-gray-950 to-black border border-amber-500/30 rounded-3xl p-10 shadow-2xl">
                            ...
                            <div className="text-center mb-10">
                                ...
                                <h1 className={`text-gray-300 text-4xl font-bold mb-2 tracking-tight`}>{raw_data.header || "Welcome Back"}</h1>
                                <p className={`text-gray-300 font-ligh`}>{raw_data.sub_header || "Sign in with your credentials"}</p>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="flex items-center cursor-pointer" htmlFor='remember_me'>
                                        ...
                                        <span className={`text-gray-300 ml-2 text-sm`}> Keep me signed in</span>
                                    </label>
                                    <CustomLink href={`${themeSett.channel_website}/forgot-password`}
                                        className={`text-sky-700 text-sm`}>Forgot password?</CustomLink>
                                </div>
