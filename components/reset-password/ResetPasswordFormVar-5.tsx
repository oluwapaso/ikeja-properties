...
const ResetPasswordFormVar5 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "ResetPasswordFormVar5",
                    ...raw_data,
                }
            },
    ...
    if (user.isLogged) {
        ...
        if (themeSett) {
            return (
                ...
                from-${themeSett.primary_color} to-${themeSett.primary_color}
                px-6 py-35 relative">
                        ...
                        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-orange-100">
                            ...
                            <div className="p-8">
                                ...
                                <div className="text-center mb-8">
                                    ...
                                    <h1 className="text-3xl font-black text-gray-900 mb-1">{raw_data.header || "Update Your Password"}</h1>
                                    <p className="text-gray-700 font-medium">{raw_data.sub_header || "Set a new password to secure your account."}</p>
                                </div>
...
export default ResetPasswordFormVar5