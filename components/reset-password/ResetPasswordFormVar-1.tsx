...
const ResetPasswordFormVar1 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "ResetPasswordFormVar1",
                    ...raw_data,
                }
            },
                ...
                <section className="min-h-screen flex items-center justify-center bg-white px-6 py-35 relative">
                    <div className="w-full max-w-md">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <h1 className="text-3xl font-bold text-gray-900">{raw_data.header || "Update Your Password"}</h1>
                            <p className="text-gray-600 mt-2">{raw_data.sub_header || "Set a new password to secure your account."}</p>
                        </div>
...
export default ResetPasswordFormVar1