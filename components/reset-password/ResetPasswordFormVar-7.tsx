...
const ResetPasswordFormVar7 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "ResetPasswordFormVar7",
                    ...raw_data,
                }
            },
                    ...
                    <div className="w-full max-w-md relative z-10">
                        ...
                        <div className="bg-gradient-to-br from-gray-900 via-gray-950 to-black border border-amber-500/30 rounded-3xl p-10 shadow-2xl">
                            ...
                            <div className="text-center mb-10">
                                ...
                                <h1 className={`text-gray-300 text-4xl font-bold mb-2 tracking-tight`}>{raw_data.header || "Update Your Password"}</h1>
                                <p className={`text-gray-300 font-ligh`}>{raw_data.sub_header || "Set a new password to secure your account."}</p>
                            </div>
...
export default ResetPasswordFormVar7