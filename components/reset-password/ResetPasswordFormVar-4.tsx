...
const ResetPasswordFormVar4 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "ResetPasswordFormVar4",
                    ...raw_data,
                }
            },
                    ...
                    <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-35">
                        <div className="w-full max-w-md">
                            ...
                            <div className="mb-10">
                                ...
                                <h1 className="text-3xl font-bold text-gray-900 mb-2">{raw_data.header || "Update Your Password"}</h1>
...
export default ResetPasswordFormVar4