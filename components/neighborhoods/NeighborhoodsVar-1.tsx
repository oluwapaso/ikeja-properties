...
import NeighborhoodCardVar1 from '../neighborhood-cards/NeighborhoodCardVar-1';
import { GiFlame } from 'react-icons/gi';
import SideAds from '../ads/SideAds';

const helpers = new Helpers();
const NeighborhoodsVar1 = ({ is_theme = false, size = 20, raw_data = {} }: { is_theme?: boolean, size?: number, raw_data?: any }) => {
