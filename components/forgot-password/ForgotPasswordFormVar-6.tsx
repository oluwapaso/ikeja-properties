...
const ForgotPasswordFormVar6 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "ForgotPasswordFormVar6",
                    ...raw_data,
                }
            },
                    ...
                    <div className="w-full max-w-lg relative z-10">
                        ...
                        border border-${helpers.adjustColorShade(themeSett.secondary_color, 1)} `}>
                            ...
                            <div className="mb-8">
                                ...
                                <h1 className={`text-${themeSett.secondary_button_text} text-3xl font-bold mb-2`}>{raw_data.header || "Forgot Password?"}</h1>
                                <p className={`text-${themeSett.secondary_button_text}`}>{raw_data.sub_header || "Enter account email below. We will send you a link to reset your password."}</p>
                            </div>
...
export default ForgotPasswordFormVar6