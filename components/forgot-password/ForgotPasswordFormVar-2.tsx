...
const ForgotPasswordFormVar2 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
        ...
        window.parent.postMessage(
            {
                ...
                data: {
                    ...
                    "type": "section",
                    "component": "ForgotPasswordFormVar2",
                    ...raw_data,
                }
            },
    ...
    if (user.isLogged) {
        ...
        if (themeSett) {
            return (
                ...
                px-6 py-35 relative`}>
                    <div className="w-full max-w-lg bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
                        {/* Header */}
                        <div className="text-center mb-8">
                            ...
                            <h1 className={`text-3xl font-bold text-${themeSett.primary_color} bg-clip-text`}>
                                {raw_data.header || "Forgot Password?"}
                            </h1>
                            <p className="text-gray-600 mt-2">
                                {raw_data.sub_header || "Enter account email below. We will send you a link to reset your password."}
                            </p>
                        </div>
...
export default ForgotPasswordFormVar2