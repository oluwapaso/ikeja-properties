...
const PrefrenceVar4 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
                    ...
                    <div className="w-full max-w-[900px] mx-auto px-8">
                        ...
                        <div className={` w-full flex justify-between`}>
                            ...
                            {!isSubmitting ?
                                ...
                                hover:bg-${helpers.adjustColorShade(themeSett.primary_color, 1)} hover:drop-shadow-md rounded
                                cursor-pointer flex items-center`} onClick={handleUpdateInfo}>
                                ...
                                text-${themeSett.primary_button_text} text-center py-4 px-4 flex items-center rounded
