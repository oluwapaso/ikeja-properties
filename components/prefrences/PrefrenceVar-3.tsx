...
const PrefrenceVar3 = ({ is_theme = false, raw_data = {} }: { is_theme?: boolean, raw_data?: any }) => {
                            ...
                            <div className="p-8">
                                ...
                                {activeTab == "Subscriptions" &&
                                    <div className="w-full flex flex-col">
                                        <h1 className="text-xl font-bold text-gray-900">Subscription Preferences</h1>
