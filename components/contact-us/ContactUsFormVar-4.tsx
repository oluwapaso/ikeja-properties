                ...
                <div className="lg:w-1/2 bg-[#1c3d2e] relative overflow-hidden">
                    ...
                    <div className="relative z-10 p-8 lg:p-16 h-full flex flex-col justify-start min-h-[50vh] lg:min-h-screen">
                        ...
                        <div className="py-12 lg:py-0 grow flex flex-col items-start justify-center">
                            ...
                            <div className="grid grid-cols-1 gap-6 shrink-0 mt-10">
                                <div className="flex items-center gap-3">
                                    <div className={`bg-${themeSett.primary_color} w-10 h-10 rounded-full flex items-center justify-center`}>
                                        <BiPhoneIncoming className={`h-4 w-4 text-${themeSett.primary_button_text}`} />
                                    </div>
                                    <div>
                                        <p className="text-white/50 text-xs">Call us</p>
                                        <p className="text-white text-sm flex flex-col space-y-1.5">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className={`bg-${themeSett.primary_color} w-10 h-10 rounded-full flex items-center justify-center`}>
                                        <CgMail className={`h-4 w-4 text-${themeSett.primary_button_text}`} />
                                    </div>
                                    <div>
                                ...
                                <div className="flex items-center gap-3">
                                    <div className={`bg-${themeSett.primary_color} w-10 h-10 rounded-full flex items-center justify-center`}>
                                        <BiMapPin className={`h-4 w-4 text-${themeSett.primary_button_text}`} />
                                    </div>
                                    <div>
